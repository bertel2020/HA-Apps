...
| --- | --- | --- | --- |
| Zeitarchiv | 0.78.0 | Kompaktes Zeitreihen-Archiv mit Parquet, Ingress, Energie-Dashboard, Charts, Importen sowie sicherer Logging- und Ingest-Diagnose. | [Anleitung](zeitarchiv/README.md) · [Dokumentation](zeitarchiv/docs/README.md) |
