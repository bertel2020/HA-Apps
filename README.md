...
| --- | --- | --- | --- |
| Zeitarchiv | 0.55.2 | Kompaktes Zeitreihen-Archiv mit Parquet, Ingress, Charts, direktem Home-Assistant-Import und Backup. | [Anleitung](zeitarchiv/README.md) · [Dokumentation](zeitarchiv/docs/README.md) |
