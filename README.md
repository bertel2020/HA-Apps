...
| --- | --- | --- | --- |
| Zeitarchiv | 0.68.0 | Kompaktes Zeitreihen-Archiv mit Parquet, Ingress, Charts, direktem Home-Assistant-Import, detaillierter Speicheranalyse und kontrollierter Index-Optimierung. | [Anleitung](zeitarchiv/README.md) · [Dokumentation](zeitarchiv/docs/README.md) |
